...
|---|---|---|---|
|01|[01-Intro-to-NLP-and-LLMs](Intro-to-NLP-and-LLMs/)|Introduction to NLP & LLM Fundamentals|GDG Carthage bootcamp – from text cleaning to embeddings and attention|
|02|[02-Intro-to-RAG](Introduction-to-RAG/)|Introduction to Retrieval-Augmented Generation|GDG Carthage bootcamp – hallucination mitigation, RAG concepts, and end-to-end demos|
...
|04|[Into-to-NLP-GODS-4.0](Into-to-NLP(GODS4.0)/)|Intro to NLP (GODS 4.0)|GO Data Science hackathon – NLP techniques, preprocessing, and classification|
...
|10|[GODS-Semantic-anomaly-detection-with-vector-search](Semantic-anomaly-detection-with-vector-search(GODS5.0)/)|Semantic Anomaly Detection with Vector Search|GO Data Science series, HDFS log monitoring with Qdrant embeddings and distance/DBSCAN detection|
