# Leafwise Machine Learning Bootcamp: Agentic Retrieval Systems with Qdrant

I was invited by the ASIA ESSAI Club at UIK University to lead this 🌿 Leafwise Machine Learning Bootcamp session on agentic retrieval systems with Qdrant. During the workshop we will cover:
- Motivation to use RAG
- RAG components
- Vector stores deep dive
- Integrating retrieval with Qdrant
...
## Session Highlights
- Understand the evolution from basic RAG to agentic retrieval workflows.
